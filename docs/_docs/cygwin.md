...
Then `go get -u -v` the following packages:
    ...
    go get -u -v github.com/reyahsolutions/grpc-gateway/protoc-gen-grpc-gateway
    go get -u -v github.com/reyahsolutions/grpc-gateway/protoc-gen-openapiv2
    go get -u -v github.com/golang/protobuf/protoc-gen-go

This will probably fail with a similar output to this:

    github.com/reyahsolutions/grpc-gateway (download)
    # cd .; git clone https://github.com/reyahsolutions/grpc-gateway C:\path\to\your\cygwin\home\user\go\src\github.com\grpc-ecosystem\grpc-gateway
    ...
    package github.com/reyahsolutions/grpc-gateway/protoc-gen-grpc-gateway: exit status 128
...
Copy and paste these lines into your shell and change the clone destination directories.
    ...
    git clone https://github.com/reyahsolutions/grpc-gateway $(cygpath -u $GOPATH)/src/github.com/reyahsolutions/grpc-gateway
...
Follow the [instructions](https://github.com/reyahsolutions/grpc-gateway#usage) in the [README](https://github.com/reyahsolutions/grpc-gateway#readme).

Adjust steps 3, 5 and 7 like this. protoc expects native Windows paths.

    protoc -I. -I$(cygpath -w /usr/local/include) -I${GOPATH}/src -I${GOPATH}/src/github.com/reyahsolutions/grpc-gateway/third_party/googleapis --go_out=plugins=grpc:. ./path/to/your_service.proto
    protoc -I. -I$(cygpath -w /usr/local/include) -I${GOPATH}/src -I${GOPATH}/src/github.com/reyahsolutions/grpc-gateway/third_party/googleapis --grpc-gateway_out=logtostderr=true:. ./path/to/your_service.proto
    protoc -I. -I$(cygpath -w /usr/local/include) -I${GOPATH}/src -I${GOPATH}/src/github.com/reyahsolutions/grpc-gateway/third_party/googleapis --openapiv2_out=logtostderr=true:. ./path/to/your_service.proto
