...
[`runtime.ServeMux`](https://pkg.go.dev/github.com/reyahsolutions/grpc-gateway/runtime?tab=doc#ServeMux).
...
libraries in Go.
e.g. https://github.com/reyahsolutions/grpc-gateway/blob/master/examples/internal/gateway/main.go
